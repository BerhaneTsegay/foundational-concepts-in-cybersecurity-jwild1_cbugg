...
// This is a good example of layering. Even as an admin-level user one can
// only receive an md5 hash of the individual values. This further requires
// a secure password to even access the admin-portal giving the data several
// layers of security.
