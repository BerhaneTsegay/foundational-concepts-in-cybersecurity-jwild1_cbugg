...
// This is a good example of least privilege. The application can be run
// using either user-level or admin-level access, with user-level access
// denying many functions and only providing the nessessary one.
